...
#define CONSOLE_COLOR_INPUT(y) \
COLORED_CONSOLE = GetStdHandle(STD_OUTPUT_HANDLE);\
SetConsoleTextAttribute(COLORED_CONSOLE,y);\

#define CONSOLE_COLOR(x,y) \
COLORED_CONSOLE = GetStdHandle(STD_OUTPUT_HANDLE);\
SetConsoleTextAttribute(COLORED_CONSOLE, y);\
std::cout << x ;\
SetConsoleTextAttribute(COLORED_CONSOLE, 15);\

#define THROW_ERROR(x) \
COLORED_CONSOLE = GetStdHandle(STD_OUTPUT_HANDLE);\
SetConsoleTextAttribute(COLORED_CONSOLE, 12);\
std::cout << x << "\n";\
SetConsoleTextAttribute(COLORED_CONSOLE, 15);\
this->dialogue(Entity, key, saying);\
return 1;\

#define THROW_ERROR_2(x,y) \
COLORED_CONSOLE = GetStdHandle(STD_OUTPUT_HANDLE);\
SetConsoleTextAttribute(COLORED_CONSOLE, y);\
std::cout << x << "\n";\
SetConsoleTextAttribute(COLORED_CONSOLE, 15);\
...
#define THROW_ERROR_3(x,y,z) \
COLORED_CONSOLE = GetStdHandle(STD_OUTPUT_HANDLE);\
SetConsoleTextAttribute(COLORED_CONSOLE, y);\
std::cout << x << "\n";\
SetConsoleTextAttribute(COLORED_CONSOLE, z);\
this->dialogue(Entity, key, saying);\
return 1;\

#define CREATE_HANDLER static HANDLE COLORED_CONSOLE;
#else 
#define THROW_ERROR(x) std::cout << x << "\n";this->dialogue(Entity, key, saying);return 1;
#define THROW_ERROR_2(x,y) std::cout << x << "\n";this->dialogue(Entity, key, saying);return 1;
#define THROW_ERROR_3(x,y,z) std::cout << x << "\n";this->dialogue(Entity, key, saying);return 1;
#define CONSOLE_COLOR(x,y) std::cout << x << "\n";
#define CONSOLE_COLOR_INPUT(x)
...
constexpr std::array<const char*,352> BlockList ={ "acacia_log",
"acacia_planks",
"acacia_wood",
"amethyst_block",
"ancient_debris",
...
constexpr std::array<const char*,78> EntityList = {"allay","axolotl",
"bat",
"bee",
"blaze",
"camel",
...
constexpr std::array<const char*, 65> BiomeList = { "the_void","plains","sunflower_plains",
"forest",
"flower_forest",
"birch_forest",
"dark_forest",
